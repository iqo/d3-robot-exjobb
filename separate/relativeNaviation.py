...
class RealtiveNavigation():
    def __init__(self):
        ...
        self.robotXCordinate = None
        self.robotYCordinate = None
        self.robotZCordinate = None
    ...
    def on_message(self, client, userdata, message):
        ...
        if "REPORT:42478B1A6B8CBA16" in jsonMessage:
            ...
            self.robotZCordinate = cordinate[2]
    ...
    def navigateTarget(self):
        try:
            if self.robotXCordinate != None and self.robotYCordinate != None and self.robotZCordinate != None and self.transmiterXCordinate != None and self.transmiterYCordinate != None and self.transmiterZCordinate != None:
                ...
                targetX = float(self.transmiterXCordinate) - float(self.robotXCordinate)
                targetY = float(self.transmiterYCordinate) - float(self.robotYCordinate)
